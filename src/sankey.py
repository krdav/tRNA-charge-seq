...
20th July, 2023, Kristian Davidsen:
This is Sankey plot code taken from: https://github.com/anazalea/pySankey
Few additions have been made to enable better sizing of plots.
...
def sankey(left, right, leftWeight=None, rightWeight=None, colorDict=None,
           ...
           fontsize=14, figure_name=None, closePlot=False, plot_size=(16, 30)):
    '''
    ...
    if figure_name!=None:
        ...
        plt.savefig("{}.pdf".format(figure_name), bbox_inches='tight')
    if closePlot:
        plt.close()
